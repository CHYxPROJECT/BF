...
local v466 = vu32:MakeWindow({
    Title = "XRUN Hub [V7]",
    SubTitle = "By Nana☑️",
    SaveFolder = "XrunHub | redz lib v5.lua"
})

v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://92263670982382", BackgroundTransparency = 1},
...
v484:AddDiscordInvite({
    Name = "XrunHub | Official Sever",
    Description = "Visit now to receive the latest notifications!",
    Logo = "rbxassetid://92263670982382",
    Invite = ""
})
v484:AddParagraph({
Title = "Have fun interacting",
    Desc = "No Toxic Swearing"
})
v484:AddParagraph({
Title = "Version: V7",
    Desc = ""
